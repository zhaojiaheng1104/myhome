...
<article class="page-container">
	<form action="/admin/user/doadd" method="post" class="form form-horizontal" enctype="multipart/form-data" >
		{{ csrf_field() }}
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="radio-box">
				...
				<div class="radio-box">
					<input type="radio" id="sex-2" name="status" value="0" checked="checked">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			<input type="file" value="" name="user_img" >
			</div>
		</div>
		<div class="row cl">
